 ...
 *
 * modified by Maren Arnhold <info@kotori.de> 2021-12-31:
 *
 * - removed word spacing
 * - caught PHP notice of lResult previously being undefined if $pNumber % 1000 == 0
 *
 */
...
$lGroupSuffix = array(array('s', ''),
                      ...
                      array('eMillion', 'Millionen'),
                      array('eMilliarde', 'Milliarden'),
                      array('eBillion', 'Billionen'),
                      array('eBilliarde', 'Billiarden'),
                      array('eTrillion', 'Trillionen'));
